...
namespace WebApplication1.Controllers
{
    public class IletisimsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IletisimID,Adres,Tel,Email,Whatsapp,Facebook,Instagram")] Iletisim iletisim)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IletisimID,Adres,Tel,Email,Whatsapp,Facebook,Instagram")] Iletisim iletisim)
        {
            if (ModelState.IsValid)
            {
